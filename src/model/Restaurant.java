...
public class Restaurant {
	...
	/**
	 * Creates a restaurant instance from JSON object
	 * 
	...
	public Restaurant(JSONObject object) {
		...
		/**
		 * Creates a restaurant instance from strings
		 * 
		 * @param businessId
		 * @param name 
		 * @param categories
	    ...
	    /**
	     * Converts Restaurant object to JSONObject
	     * 
	...
	// Performs data cleanup from Yelp API
